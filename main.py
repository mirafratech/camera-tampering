...
if __name__ == "__main__":
    ...
    def predict(model_path, test_path,image_size):
        obj_pred = Predict(model_path, test_path,image_size)
        obj_pred.csv_file()
    ...
    parser.add_argument("Model",
                        nargs="?",
                        choices=['training', 'predict', 'validation'],
                        default='training',
                        )
    ...
    if args.Model == "training":
        ...
        parser.add_argument('-output_path', type=str, default="model/weights.best.trained.hdf5")
        parser.add_argument('-model_train', type=str, default='VGG16')
        ...
        parser.add_argument('-model_path', type=str, default="model/weights.best.trained.hdf5")
        parser.add_argument('-image_size', type=str, default=256)
        args = parser.parse_args(sub_args)
        predict(args.model_path, args.test_path, args.image_size)
